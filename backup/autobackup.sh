...
RED="\033[0;31m"
GREEN="\033[0;32m" 
COLOR1="$(cat /etc/rapzvpn/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/rapzvpn/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"  
WH='\033[1;37m'
...
echo -e "$COLOR1 ${NC}                 ${WH}• RAPZVPN STORE •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
