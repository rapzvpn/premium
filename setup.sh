...
#########################
CDNF="https://raw.githubusercontent.com/huutvpn/premium/master"
clear 
red='\e[1;31m'
green='\e[0;32m'
yell='\e[1;33m'
...
url_izin='https://raw.githubusercontent.com/rapzvpn/izin/master/izin'
...
sleep 2
clear
wget https://raw.githubusercontent.com/rapzvpn/premium/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rapzvpn/premium/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/rapzvpn/premium/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
#Install Update Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rapzvpn/premium/master/update.sh && chmod +x update.sh && ./update.sh
#Install UDP CUSTOM 
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rapzvpn/premium/master/udp.sh && chmod +x udp.sh && ./udp.sh
clear
